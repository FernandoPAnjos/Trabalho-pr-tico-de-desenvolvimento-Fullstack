...
import { SelectionModel } from '@angular/cdk/collections'; // <-- Para gerenciar a seleção
import { MatTableDataSource } from '@angular/material/table'; // <-- Para funcionalidades extras da tabela

// Imports do Material necessários
